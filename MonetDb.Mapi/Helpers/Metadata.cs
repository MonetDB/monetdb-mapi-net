namespace MonetDb.Mapi.Helpers
{
    ...
    internal class Metadata : IDisposable
    {
        ...
        /// Parent connection
        /// </summary>
        private readonly MonetDbConnection connection;
        ...
        private MonetDbCommand GetCommand()
        {
            lock (_lock)
            {
                return this.connection.CreateCommand() as MonetDbCommand;
            }
        }
        ...
        public string GetEnvironmentVariable(string keyName)
        {
            lock (_lock)
            {
                ...
                _environmentVariables[this.connection] = envs;
        ...
        private IList<FunctionInfo> GetFunctions(FunctionType kind)
        {
        ...
        public IList<FunctionInfo> GetNumericFunctions()
        {
            return GetFunctions(FunctionType.Numeric);
        }

        public IList<FunctionInfo> GetStringFunctions()
        {
            return GetFunctions(FunctionType.String);
        }

        public IList<FunctionInfo> GetSystemFunctions()
        {
            return GetFunctions(FunctionType.System);
        }

        public IList<FunctionInfo> GetDateTimeFunctions()
        {
            return GetFunctions(FunctionType.DateTime);
        }
        ...
        /// <returns></returns>
        public IList<ProcedureInfo> GetProcedures(string catalog
        ...
        /// <returns></returns>
        public IList<TableInfo> GetTables(
            string catalog,
            string schemaPattern,
        ...
        /// <param name="schemaPattern"></param>
        /// <returns></returns>
        public IList<SchemaInfo> GetSchemas(
            string catalog,
            string schemaPattern)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IList<CatalogInfo> GetCatalogs()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IList<TableTypeInfo> GetTableTypes()
        {
            // The results need to be ordered by TABLE_TYPE
            var types = new List<TableTypeInfo>
            {
                new TableTypeInfo {Name = "SESSION TABLE"},
                new TableTypeInfo {Name = "SESSION VIEW"},
                new TableTypeInfo {Name = "SYSTEM SESSION TABLE"},
                new TableTypeInfo {Name = "SYSTEM SESSION VIEW"},
                new TableTypeInfo {Name = "SYSTEM TABLE"},
                new TableTypeInfo {Name = "SYSTEM VIEW"},
                new TableTypeInfo {Name = "TABLE"},
                new TableTypeInfo {Name = "VIEW"}
            };
        ...
        /// <returns></returns>
        public IList<ColumnInfo> GetColumns(
            string catalog,
